...
# Form implementation generated from reading ui file 'trabajosVisitados.ui'
#
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.ca_btn_cancelar.setGeometry(QtCore.QRect(270, 290, 111, 31))
...
"font-size:15px;")
        ...
        self.ca_btn_3.setGeometry(QtCore.QRect(70, 210, 311, 41))
...
"font-size:15px;")
    ...
    def retranslateUi(self, Form):
        ...
        self.ca_btn_2.setText(_translate("Form", "Consultar trabajos controlados"))
        self.label.setText(_translate("Form", "Trabajos Controlados"))
        self.ca_btn_1.setText(_translate("Form", "Agregar trabajo controlado"))
        self.ca_btn_3.setText(_translate("Form", "Eliminar trabajos  controlados"))
