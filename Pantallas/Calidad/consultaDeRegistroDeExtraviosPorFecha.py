...
# Form implementation generated from reading ui file 'consultaDeRegistroDeExtraviosPorFecha.ui'
#
...
"background-color:#ff4e4e;")
        ...
        self.ca_input_fecha = QtWidgets.QDateEdit(Form)
        self.ca_input_fecha.setGeometry(QtCore.QRect(30, 110, 551, 31))
        self.ca_input_fecha.setStyleSheet("border:none;\n"
"background-color: rgb(255, 255, 255);\n"
"font: 11pt \"MS Shell Dlg 2\";")
        self.ca_input_fecha.setObjectName("ca_input_fecha")
    ...
    def retranslateUi(self, Form):
        ...
        self.label_2.setText(_translate("Form", "Consulta de registros de moviles"))
        ...
        self.label.setText(_translate("Form", "Ingrese fecha"))
