...
# Form implementation generated from reading ui file 'registroDeExtraviosOpcion.ui'
#
...
"font-size:15px;")
        ...
        self.ca_btn_cancelar.setGeometry(QtCore.QRect(270, 350, 111, 31))
...
"")
    ...
    def retranslateUi(self, Form):
        ...
        self.ca_btn_4.setText(_translate("Form", "Consultar extravíos por movil"))
        self.ca_btn_3.setText(_translate("Form", "Consultar extravíos por Técnico"))
        self.ca_btn_cancelar.setText(_translate("Form", "Cancelar"))
        self.ca_btn_1.setText(_translate("Form", "Consultar extravíos por fecha"))
        self.ca_btn_2.setText(_translate("Form", "Consultar extravíos por MAC"))
        self.label.setText(_translate("Form", "Registro de extravíos"))
