...
"font-size:15px;")
    ...
    def retranslateUi(self, Form):
        ...
        self.ca_btn_2.setText(_translate("Form", "Consulta de descuentos"))
        self.label.setText(_translate("Form", "Descuentos"))
        self.ca_btn_1.setText(_translate("Form", "Agregar descuento por extravío"))
