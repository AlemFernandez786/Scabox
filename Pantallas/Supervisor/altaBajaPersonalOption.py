...
# Form implementation generated from reading ui file 'altaBajaPersonalOption.ui'
#
...
"font-size:15px;")
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "Alta Baja - Personal"))
        self.label.setText(_translate("Form", "<html><head/><body><p align=\"center\"><span style=\" font-size:15pt;\">Alta/Baja de Personal</span></p></body></html>"))
        self.su_btn_1.setText(_translate("Form", "ALTA"))
        self.su_btn_2.setText(_translate("Form", "BAJA"))
