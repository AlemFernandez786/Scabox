...
"text-align:center;")
        ...
        self.se_btn_cancelar.setGeometry(QtCore.QRect(320, 350, 131, 31))
...
"")
        ...
        self.se_cbx_1 = QtWidgets.QComboBox(Form)
        self.se_cbx_1.setGeometry(QtCore.QRect(220, 250, 271, 31))
        self.se_cbx_1.setStyleSheet("border:none;\n"
                                    "background-color: rgb(255, 255, 255);\n"
                                    "font: 11pt \"MS Shell Dlg 2\";")
        self.se_cbx_1.setObjectName("se_cbx_1")
        self.se_cbx_1.addItem("")
        self.se_cbx_1.addItem("")
        self.se_cbx_1.addItem("")
    ...
    def retranslateUi(self, Form):
        ...
        self.label_3.setText("Serializable")
        self.label_4.setText("Estado")
