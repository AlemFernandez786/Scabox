...
"font: 11pt \"MS Shell Dlg 2\";color:black;")
        ...
        self.ma_tabla_valores = QtWidgets.QTreeWidget(Form)
        self.ma_tabla_valores.setGeometry(QtCore.QRect(10, 130, 821, 171))
        self.ma_tabla_valores.setObjectName("ma_tabla_valores")
        font = QtGui.QFont()
        font.setPointSize(12)
        self.ma_tabla_valores.headerItem().setFont(0, font)
        font = QtGui.QFont()
        font.setPointSize(11)
        self.ma_tabla_valores.headerItem().setFont(1, font)
        font = QtGui.QFont()
        font.setPointSize(11)
        self.ma_tabla_valores.headerItem().setFont(2, font)
        font = QtGui.QFont()
        font.setPointSize(11)
        self.ma_tabla_valores.headerItem().setFont(3, font)
        font = QtGui.QFont()
        font.setPointSize(12)
        self.ma_tabla_valores.headerItem().setFont(4, font)
        font = QtGui.QFont()
        font.setPointSize(11)
        self.ma_tabla_valores.headerItem().setFont(5, font)
...
"text-align:center;")
    ...
    def retranslateUi(self, Form):
        ...
        self.ma_tabla_valores.headerItem().setText(0, _translate("Form", "Codigo"))
        self.ma_tabla_valores.headerItem().setText(1, _translate("Form", "Descripcion"))
        self.ma_tabla_valores.headerItem().setText(2, _translate("Form", "Cantidad de Stock disponible"))
        self.ma_tabla_valores.headerItem().setText(3, _translate("Form", "Stock utilizado en los ultimos 30 dias"))
        self.ma_tabla_valores.headerItem().setText(4, _translate("Form", "Stock Minimo permitido"))
        self.ma_tabla_valores.headerItem().setText(5, _translate("Form", "Stock Maximo permitido"))
