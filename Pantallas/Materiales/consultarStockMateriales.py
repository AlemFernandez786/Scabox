...
"border:none;")
    ...
    def retranslateUi(self, Form):
        ...
        __sortingEnabled = self.ma_tabla_datos.isSortingEnabled()
        self.ma_tabla_datos.setSortingEnabled(False)
        self.ma_tabla_datos.setSortingEnabled(__sortingEnabled)
